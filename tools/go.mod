module github.com/zachfi/iotcontroller/tools

go 1.26

replace (
	// Satisfy placeholder required by transitive deps (e.g. from buf or other tools) so go mod tidy can resolve.
	github.com/docker/docker => github.com/docker/docker v28.0.4+incompatible
	// golangci-lint v2 needs x/tools with hostport, modernize, go/ast/edge (v0.40+); avoid old v0.24.0 that fails on Go 1.26.
...
require (
	...
	github.com/grafana/tanka v0.31.3
